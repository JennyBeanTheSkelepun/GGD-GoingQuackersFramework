...
bool Shader::Initialize(ID3D11Device* device, HWND hwnd)
{
	...
	result = InitializeShader(device, hwnd, (WCHAR*)(L"Code/EngineBase/Graphics/Shader/Shaders/TextureSimple.fx"), (WCHAR*)(L"Code/EngineBase/Graphics/Shader/Shaders/TextureSimple.fx"));
	if (!result)
	{
		return false;
	}
